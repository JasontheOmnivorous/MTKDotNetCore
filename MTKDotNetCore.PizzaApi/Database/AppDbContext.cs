...
public class PizzaExtraModel
{
    ...
    // NotMapped means this statement is not mapped from database
    [NotMapped]
    // add $ to each Price when mapping
...
public class PizzaOrderDetailInvoiceHeadModel
{
    public int PizzaOrderDetailId { get; set; }
    public string PizzaOrderInvoiceNo { get; set; }
    public int PizzaExtraId { get; set; }
...
public class PizzaOrderInvoiceResponse
{
    ...
    public List<PizzaOrderDetailInvoiceHeadModel> OrderDetail { get; set; }
}
